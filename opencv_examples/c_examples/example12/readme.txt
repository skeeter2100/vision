...
*******************************************************
    ...
    Usage: ./example12 imageName 

    Command Line Arguments

        ./example12: name of executable
...
1. Folder example12 contains the following files:
...
2.  Command Line Build
    ...
    % g++ -Wall -g example12.c -o example12 $(pkg-config --cflags --libs opencv)
