...
*******************************************************
    ...
    Usage: ./example13 <camera index>

    Command Line Arguments

        ./example13: name of executable
...
1. Folder example13 contains the following files:
...
2.  Command Line Build
    ...
    % g++ -Wall -g example13.c -o example13 $(pkg-config --cflags --libs opencv)
